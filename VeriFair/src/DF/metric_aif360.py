...
def measure_fairness_aif360(model, X_test, y_test, feature_names, 
    ...
    # For ordinal SEX: 0=Male (unprivileged), 1=Female (privileged)
...
if __name__ == "__main__":
    ...
    # print("\n=== FAIRNESS METRICS (AIF360) ===")
    # measure_fairness_aif360(model_1, X_test, y_test, feature_names, protected_attribute='SEX')
    # print("="*40)
    ...
    # print("\n=== FAIRNESS METRICS (AIF360) ===")
    # measure_fairness_aif360(model_2, X_test, y_test, feature_names, protected_attribute='SEX')
    # print("="*40)
    ...
    # print("\n=== FAIRNESS METRICS (AIF360) ===")
    # measure_fairness_aif360(model_3, X_test, y_test, feature_names, protected_attribute='SEX')
    # print("="*40)
    ...
    # print("\n=== FAIRNESS METRICS (AIF360) ===")
    # measure_fairness_aif360(model_4, X_test, y_test, feature_names, protected_attribute='SEX')
    # print("="*40)
    ...
    # print("\n=== FAIRNESS METRICS (AIF360) ===")
    # measure_fairness_aif360(model_5, X_test, y_test, feature_names, protected_attribute='SEX')
    # print("="*40)
    ...
    print("\n=== FAIRNESS METRICS (AIF360) ===")
    measure_fairness_aif360(model_6, X_test, y_test, feature_names, protected_attribute='SEX')
    print("="*40)
...
#     # Define feature names based on the NEW ordinal encoding preprocessing
#     # Order matches the columns after preprocessing in load_default()
#     feature_names = [
#         'LIMIT_BAL', 'SEX', 'EDUCATION', 'MARRIAGE', 'AGE',
#         'PAY_1', 'PAY_2', 'PAY_3', 'PAY_4', 'PAY_5', 'PAY_6',
#         'BILL_AMT1', 'BILL_AMT2', 'BILL_AMT3', 'BILL_AMT4', 'BILL_AMT5', 'BILL_AMT6',
...
#     print(f"Actual features in X_test: {X_test.shape[1]}")
    
#     if len(feature_names) != X_test.shape[1]:
#         print("\n⚠️  FEATURE MISMATCH!")
#         print(f"Difference: {X_test.shape[1] - len(feature_names)} features")
#         sys.exit(1)
#     else:
...
#     original_metrics = measure_fairness_aif360(
#         original_model, X_test, y_test, 
#         feature_names, protected_attribute='SEX'
#     )
    
#     print("\n=== FAIRER MODEL FAIRNESS (AIF360) ===")
#     fairer_metrics = measure_fairness_aif360(
#         fairer_model, X_test, y_test, 
#         feature_names, protected_attribute='SEX'
#     )
