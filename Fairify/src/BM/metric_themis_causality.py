#!/usr/bin/env python3
"""
Themis++ Evaluation for Bank Marketing Dataset
...
if __name__ == "__main__":
    ...
    model_1_path = 'Fairify/models/bank/BM-13.h5'
    model_2_path = 'Fairify/models/bank/BM-13-AdvDb.h5'
    model_3_path = 'Fairify/models/bank/BM-13-Ruler.h5'
    model_4_path = 'Fairify/models/bank/BM-13-Runner.h5'
    model_5_path = 'Fairify/models/bank/BM-13-Neufair.h5'
    model_6_path = 'Fairify/models/bank/BM-13-Retrained.h5'
    ...
    def run_causal_eval(model_path, model, sampling_method='sobol'):
        ...
        print(f"Running Advanced Causal Discrimination Check on 'age' with {sampling_method} sampling...")
        _, rate, _, stats = detector.causal_discrimination(['age'])
    ...
    # Run all Bank Marketing models with Sobol sampling
    print("\n" + "="*80)
    print("TESTING ALL BANK MARKETING MODELS WITH THEMIS++ (SOBOL SAMPLING)")
    print("="*80)
