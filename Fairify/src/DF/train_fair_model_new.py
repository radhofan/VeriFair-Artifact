...
from utils.verif_utils import load_default
...
def evaluate_model_with_lr(lr, model_name, X_train_mixed, y_train_mixed, 
    ...
    # Load fresh model
    test_model = load_model(f'Fairify/models/default/{model_name}.h5')
    test_model.compile(
...
set_all_seeds(42)
final_model = load_model(f'Fairify/models/default/{ORIGINAL_MODEL_NAME}.h5')
final_model.compile(
...
final_model.save(f'Fairify/models/default/{FAIRER_MODEL_NAME}.h5')
