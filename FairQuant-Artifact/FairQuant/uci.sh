...
if [ "$PA" == "sex" ]; then
    idx=1 # 8 stands for sex
else
    echo "Error: invalid PA provided for uci: sex"
    exit 1
fi
...
./FairQuant-Artifact/FairQuant/network_test "FairQuant-Artifact/models/uci/UCI-5.nnet" "$idx" 